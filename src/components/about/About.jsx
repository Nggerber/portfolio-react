...
function About(props) {
    return (
        <div>
            ...
            <Container fluid>
                <Row>
                    <Col><h2 className="font-weight-bolder p-5">About Me</h2></Col>
                </Row>
            </Container>
            <Container>
                <Row>
                    <Col>
                        <Image className="block-example border border-dark rounded mb-0" src={profilepic} fluid alt="me with my millenium falcon shirt" />
                    </Col>
                    <Col sm={5}>
